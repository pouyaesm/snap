#ifndef R_WORD_2_VEC_H
#define R_WORD_2_VEC_H

///Learns embeddings using SGD, Skip-gram with negative sampling.
void LearnEmbeddings(TVVec<TInt, int64>& WalksVV,
	const int& Dimensions, const int& WinSize, const int& roleCount,
	const bool& roleNegativeSampling,
